...
```{r hypotenuse_substitute2, eval=FALSE}
substitute2(
...
```{r hypotenuse_datatable, eval=FALSE}
...
```{r hypotenuse_datatable_i_j_by, eval=FALSE}
...
```{r substitute2_recursive, eval=FALSE}
...
```{r splice_substitute2_not, eval=FALSE}
